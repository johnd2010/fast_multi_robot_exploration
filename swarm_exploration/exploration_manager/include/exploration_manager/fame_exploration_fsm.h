...
private:
  ...
  void diagnosticCallback(const mrs_modules_msgs::OctomapPlannerDiagnostics& msg);
  ...
  mrs_modules_msgs::OctomapPlannerDiagnostics mrs_diagnostics_;
  ...
  ros::Subscriber trigger_sub_, odom_sub_,idle_sub;
